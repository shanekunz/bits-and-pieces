---
title: Effortless Focused Journaling & Note-Taking
draft: false
tags:
  - journaling
  - note-taking
...
### Why? 
It's offline, it stores all the notes you want, and it lets you easily link files together, which creates a knowledge tree. Simple. You don't need to get distracted searching the web or ever opening your mind to the internet to use it day-to-day. If you want them stored across devices with common cloud storage like OneDrive, iCloud, or Google Drive, it just works out of the box. Your notes, your 'vault', are stored in a private folder that you fully control.
...
By applying a custom CSS snippet, you can hide distracting interface elements in Obsidian, creating a cleaner, distraction-free workspace that helps you focus on your writing.
With Obsidian open:
...
### Next we need to hide distracting operating system elements, so you forget you're even on a computer.
MacOS has a decent setting to hide the Dock or enter full screen with the green icon in the top of any window.
...
I've used it for a long time, and it works reliably.
...
Now whenever your computer turns on, you can press Ctrl+Escape to hide the taskbar without going into settings.
...
# And whatever you do...
### Don't Stop Writing. 
#### Is it a computer or a typewriter at this point? You decide.
